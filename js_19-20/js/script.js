...
$(document).ready(function(){
    $(".banners_tab:first").addClass("active");
    $(".banners_tab_item:not(:first)").hide();
 
    $(".banners_tab ").click(function(){
 
        $(this).next(".banners_tab_item").slideToggle()
        .siblings(".banners_tab_item:visible").slideUp();
        $(this).toggleClass("active");
        $(this).siblings(".banners_tab").removeClass("active");
     });
